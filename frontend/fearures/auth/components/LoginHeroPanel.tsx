...
export default function LoginHeroPanel({ className = "" }: Props) {
  return (
    <div className={`relative overflow-hidden bg-aura-black ${className}`}>
      ...
      {/* Maroon radial glow behind products */}
      <div
      ...
      <div className="relative z-10 flex h-full w-full flex-col justify-between p-8 xl:p-10">
        ...
        {/* Middle Content — TIMELESS BY NATURE / Crafted for You */}
        <div className="flex flex-col">
          <motion.div
            custom={1}
            initial="hidden"
            ...
            variants={fadeUp}
          >
            <h2 className="font-anton text-6xl uppercase leading-[0.95] text-white drop-shadow-2xl xl:text-7xl">
              Timeless
            </h2>
            <h2 className="font-anton text-6xl uppercase leading-[0.95] text-aura-maroon drop-shadow-2xl xl:text-7xl">
              By Nature
            </h2>
            <p className="mt-2 font-dancing text-4xl text-aura-amber drop-shadow-lg xl:text-5xl">
              Crafted for You
            </p>
          ...
          <motion.p
            ...
            animate="show"
            variants={fadeUp}
            className="mt-5 max-w-[280px] text-sm leading-relaxed text-white/80 drop-shadow-md"
          >
            Premium watches. Signature wallets. Fine fragrances. Designed for
            those who appreciate sophistication in every detail.
          </motion.p>
        </div>
